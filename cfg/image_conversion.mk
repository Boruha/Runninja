...
#PALETTE=1 0 2 3 8 9 11 12 14 15 17 18 20 24 25 26
PALETTE=17 0 1 2 3 4 5 6 7 8 11 13 15 20 24 26

# COLORES NINJA: 1 14 8 17 0 15
# COLORES SHURIKEN: 0 13 26
...
$(eval $(call IMG2SP, SET_PALETTE_FW  , $(PALETTE)         ))
$(eval $(call IMG2SP, CONVERT         , images/ninja.png , 10, 26, sp_ninja, palette_ninja))
$(eval $(call IMG2SP, CONVERT         , images/shuriken.png , 8, 16, sp_shuriken))
$(eval $(call IMG2SP, CONVERT         , images/orbe.png , 4, 8, sp_orb))
$(eval $(call IMG2SP, CONVERT         , images/plantaI.png , 12, 28, sp_planti))
$(eval $(call IMG2SP, CONVERT         , images/plantaD.png , 12, 28, sp_plantd))

$(eval $(call IMG2SP, SET_IMG_FORMAT  , screen))
$(eval $(call IMG2SP, SET_OUTPUT      , bin))
$(eval $(call IMG2SP, SET_FOLDER      , bin/ ))
$(eval $(call IMG2SP, CONVERT         , images/ninjaInicio.png, 160, 200, bg_ninjaInicio))
$(eval $(call IMG2SP, CONVERT         , images/background.png, 160, 200, bg_background))
$(eval $(call IMG2SP, CONVERT         , images/win.png, 160, 200, bg_win))

#$(eval $(call IMG2SP, SET_IMG_FORMAT  , screen))
#$(eval $(call IMG2SP, CONVERT         , images/fondo.png , 160, 200, bg_fondo))
...
#$(eval $(call IMG2SPRITES,images/sword.png,0,sprite,8,12,$(PALETTE),,src/assets/sprites,hwpalette))
# LA PALETA NO SE DEBE GENERAR 2 VECES
