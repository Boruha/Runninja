...
$(eval $(call ADD2PACK,compresion,bin/ninjaInicio.bin))
$(eval $(call PACKZX7B,compresion,bin/compressed/))

$(eval $(call ADD2PACK,compresionFondo,bin/background.bin))
$(eval $(call PACKZX7B,compresionFondo,bin/compressed/))

$(eval $(call ADD2PACK,compresionWin,bin/win.bin))
$(eval $(call PACKZX7B,compresionWin,bin/compressed/))
